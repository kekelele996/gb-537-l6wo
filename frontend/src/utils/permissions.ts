...
export type Permission = 'anchor.write' | 'chain.write' | 'dependency.write' | 'scenario.write' | 'scenario.run' | 'scenario.signoff' | 'scenario.verify' | 'audit.read'
...
const permissions: Record<Role, Permission[]> = {
  ...
  service_owner: ['dependency.write', 'scenario.write', 'scenario.run', 'scenario.signoff'],
