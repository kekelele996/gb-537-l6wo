...
func Open(cfg config.Config) (*gorm.DB, error) {
	...
	if err := db.AutoMigrate(&model.User{}, &model.TrustAnchor{}, &model.CertificateChain{}, &model.DependentService{}, &model.RolloverScenario{}, &model.ScenarioRiskSignoff{}, &model.AuditLog{}); err != nil {
